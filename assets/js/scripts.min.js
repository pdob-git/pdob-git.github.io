window.addEventListener("load",function(){var e=this.document.getElementById("about-perfeton-blog");if(document.baseURI.includes("about")&&e){let o=e.getBoundingClientRect().top+window.scrollY;o-=60,console.log(o),clearTimeout(void 0),setTimeout(function(){window.scroll({top:o,behavior:"smooth"})},3e3)}});
...
!function(){"use strict";var e,t=document.querySelector(".cookies");function o(){var e,t,o,n;e="cookieAllowed",t="true",o=730,(n=new Date).setTime(n.getTime()+24*o*60*60*1e3),o="expires="+n.toUTCString(),document.cookie=e+"="+t+";"+o+";path=/",document.getElementById("cookie-div").style.display="none"}document.addEventListener("DOMContentLoaded",()=>{"true"===function(e){var o=e+"=",n=decodeURIComponent(document.cookie).split(";");for(let t=0;t<n.length;t++){let e=n[t];for(;" "==e.charAt(0);)e=e.substring(1);if(0==e.indexOf(o))return e.substring(o.length,e.length)}return""}("cookieAllowed")&&o()}),t&&(t=document.querySelector("button#close"),e=document.querySelector("button#ok"),console.log(t),console.log(e),t.addEventListener("click",o),e.addEventListener("click",o))}();
