window.addEventListener("load",function(){var o=this.document.getElementById("about-perfeton-blog");if(document.baseURI.includes("about")&&o){{let e=o.getBoundingClientRect().top+window.scrollY;clearTimeout(void 0),setTimeout(function(){window.scroll({top:e,behavior:"smooth"})},3e3)}this.window.removeEventListener("load")}});
...
!function(){"use strict";var e,o;function t(){document.getElementById("cookie-div").style.display="none"}document.querySelector(".cookies")&&(e=document.querySelector("button#close"),o=document.querySelector("button#ok"),console.log(e),console.log(o),e.addEventListener("click",t),o.addEventListener("click",t))}();
