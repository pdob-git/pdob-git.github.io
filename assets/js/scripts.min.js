...
!function(){"use strict";var e,t=document.querySelector(".recommendation"),n=(t.getElementsByTagName("button").querySelector(".hidding"),!1);function o(){0!=document.body.scrollTop||0!=document.documentElement.scrollTop?(window.scrollBy(0,-50),e=setTimeout(o,10)):clearTimeout(e)}t&&(t.querySelector(".message button").addEventListener("click",function(){return o(),!1}),document.addEventListener("stillReading",function(e){n&&(t.style.bottom="-100%",n=!1)},!1),document.addEventListener("finishedReading",function(e){n||(t.style.bottom="0%",n=!0)},!1))}();
